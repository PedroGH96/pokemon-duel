...
public class Player {
    ...
    private List<String> shinyPokemonIds;    // subconjunto de unlockedPokemonIds que é shiny
    ...
    public Player() {
        ...
        this.shinyPokemonIds = new ArrayList<>();
    ...
    public List<String> getShinyPokemonIds() {
        if (shinyPokemonIds == null) shinyPokemonIds = new ArrayList<>();
        return shinyPokemonIds;
    }
    public void setShinyPokemonIds(List<String> shinyPokemonIds) { this.shinyPokemonIds = shinyPokemonIds; }
